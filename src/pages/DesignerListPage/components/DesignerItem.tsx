    ...
    <div className="bg-white ">
      <div className="border-b border-gray-200 py-[22px] px-[28px] flex justify-between">
        <div className="w-[166px] ">
          <p className="text-[10px] mb-1 text-[#737373]">{designer.shop_address}</p>
          <p className="text-[16px] mb-2">{designer.name}</p>
          <p className="text-[14px] text-[#676767]">{designer.introduction}</p>
          <div className="flex gap-2 mt-4">
            <div className="bg-[#D896FF] rounded-full px-2 py-1">
            ...
            {designerModeFormat(designer.available_modes as DesignerMode)?.map((mode) => (
              <div className="bg-[#f4f4f4] rounded-full px-2 py-1 whitespace-nowrap" key={mode}>
